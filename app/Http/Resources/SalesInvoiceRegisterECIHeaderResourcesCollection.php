...
class SalesInvoiceRegisterECIHeaderResourcesCollection extends ResourceCollection
{
    public $collects = SalesInvoiceRegisterECIHeaderResources::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => SalesInvoiceRegisterECIHeaderResources::collection($this->collection),
