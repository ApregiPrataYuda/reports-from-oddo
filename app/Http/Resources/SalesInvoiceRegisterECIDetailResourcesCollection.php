...
class SalesInvoiceRegisterECIDetailResourcesCollection extends ResourceCollection
{
    
    public $collects = SalesInvoiceRegisterECIDetailResources::class;
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => SalesInvoiceRegisterECIDetailResources::collection($this->collection),
            'pagination' => [
                'total'         => $this->total,
                'per_page'      => $limit,
